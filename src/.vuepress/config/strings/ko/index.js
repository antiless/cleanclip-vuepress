...
module.exports = {
  ...
  promotion_alternative_to_vote: 'iOS 버전 출시 중 · <em><b>얼리버드 전용 30% 할인</b><span class="underline underline-5px background-image-tint-red"></span></em> · 하나의 라이선스로 Mac/iPhone/iPad 지원（선착순）',
  promotion_alternative_to_vote_url: 'https://ios.cleanclip.cc',
  promotion_alternative_to_vote_action: '지금 할인 받기',
  sidebar: sidebar,
  nav: nav,
}