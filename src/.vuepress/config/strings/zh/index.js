...
module.exports = {
  ...
  promotion_alternative_to_vote: 'iOS 版本现已发布 · <em><b>早鸟专享7折优惠</b><span class="underline underline-5px background-image-tint-red"></span></em> · 一个许可证支持 Mac/iPhone/iPad（名额有限）',
  promotion_alternative_to_vote_url: 'https://ios.cleanclip.cc',
  promotion_alternative_to_vote_action: '立即领取优惠',
}