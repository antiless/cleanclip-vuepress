...
module.exports = {
  ...
  promotion_alternative_to_vote: 'ブラックフライデー特典：すべてのマルチデバイスプランが <em><b>30% OFF</b><span class="underline underline-5px background-image-tint-red"></span></em>。期間限定：2024年12月4日まで',
  promotion_alternative_to_vote_url: 'https://clip-purchase.macaify.com?utm_source=cleanclip&checkout[discount_code]=BF2024',
  promotion_alternative_to_vote_action: '特典を受ける >',
  sidebar: sidebar,
  nav: nav,
}