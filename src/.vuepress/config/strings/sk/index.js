...
module.exports = {
  ...
  promotion_alternative_to_vote: 'Black Friday zľava: <em><b>30% zľava</b><span class="underline underline-5px background-image-tint-red"></span></em> na všetky multi-zariadenia plány. Ponuka končí: 04.12.2024',
  promotion_alternative_to_vote_url: 'https://clip-purchase.macaify.com?utm_source=cleanclip&checkout[discount_code]=BF2024',
  promotion_alternative_to_vote_action: 'Získať zľavu >',
  sidebar: sidebar,
  nav: nav,
}